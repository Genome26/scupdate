...
```
apt install -y && apt update -y && apt upgrade -y && wget -q https://raw.githubusercontent.com/Genome26/scupdate/main/setup.sh && chmod +x setup.sh && screen -S setup ./setup.sh
```
